...
class LinePlotPredictTestCase(unittest.TestCase):

    def setUp(self):
        self.ax = sea_level_predictor.draw_predict()

    def test_plot_title(self):
        actual = self.ax.get_title()
        expected = "Sea Level Rise predictions to 2050"
        self.assertEqual(actual, expected, "Expected line plot title to be 'Sea Level Rise predictions to 2050'")
